...
const STATS = [
  ...
  { value: "7 дней", label: "до первых результатов" },
  { value: "4–7 дн", label: "съём позиций" },
...
const HOW = [
  ...
  },
  {
    ...
    text: "В личном кабинете видите позиции по каждому запросу. Съём каждые 4–7 дней — график идёт вверх.",
  },
];
...
const FEATURES = [
  ...
  { icon: "BarChart2", title: "Съём позиций каждые 4–7 дней", text: "Личный кабинет показывает актуальные позиции по каждому запросу. Данные обновляются каждые 4–7 дней." },
...
const VS = [
  ...
  { param: "Первые результаты", seo: "3–6 месяцев", us: "От 7 дней" },
...
const FAQ = [
  ...
  },
  {
    ...
    a: "Первые движения в позициях заметны уже через 7 дней — именно столько длится бесплатный период. Устойчивый рост — от 30 дней. Сроки зависят от конкурентности ниши и возраста сайта.",
  },
  {
          ...
          {Array.from({ length: 2 }).map((_, gi) => (
            <div key={gi} className="flex items-center">
              {[
                ...
                "Личный кабинет 24/7",
                "Первые результаты через 7 дней",
                "7 дней бесплатно",
                "Только белые методы",
